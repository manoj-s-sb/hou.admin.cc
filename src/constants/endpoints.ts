const endpoints = {
  ...
  centres: {
    ...
    // POST { facilityCode, waitlistId, status } — status is one of not_contacted/contacted/converted/not_interested
    ...
    // POST { facilityCode, leadId, status } — status is one of not_contacted/contacted/converted/not_interested
