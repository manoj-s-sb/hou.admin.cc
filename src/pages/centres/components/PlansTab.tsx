    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
        {breakdown.map(b => {
          ...
          return (
            <div key={b.planId} style={{ background: '#fff', border: '1px solid var(--border)', borderLeft: `4px solid ${colour}`, borderRadius: 10, padding: 16 }}>
      ...
      <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--sub)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 14 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14, marginBottom: 28 }}>
        {[
          ...
          <div key={c.k} style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 10, padding: 14 }}>
      ...
      <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 10, padding: 40, textAlign: 'center', color: 'var(--sub)' }}>
        <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--text)', marginBottom: 4 }}>No discounts configured</div>
